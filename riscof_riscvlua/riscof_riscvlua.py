...
class riscvlua(pluginTemplate):
    __model__ = "riscvlua"

    #TODO: please update the below to indicate family, version, etc of your DUT.
    __version__ = "riscvlua32"
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "","riscvlua")
    ...
    def initialise(self, suite, work_dir, archtest_env):
       ...
       self.compile_cmd = 'riscv64-unknown-elf-gcc -march={0} \
         --specs=picolibc.specs -static -mcmodel=medany -fvisibility=hidden -nostdlib -nostartfiles -g\
    ...
    def runTests(self, testList):
	  ...
	  # echo statement.
          if self.target_run:
            ...
            simcmd = self.dut_exe + ' --quiet --log {0} --isa {1} --signature {2} {3}'.format(log_file, self.isa, sig_file, elf)
